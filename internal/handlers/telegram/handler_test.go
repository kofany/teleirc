...
func TestVideoHandlerWithUsername(t *testing.T) {
    testUser := &tgbotapi.User{
        ID:        1,
        UserName:  "testuser",
        FirstName: "testing",
    ...
    correct := "testuser shared a video on Telegram with caption: 'Video content'."
...
func TestVoiceHandlerWithUsername(t *testing.T) {
    testUser := &tgbotapi.User{
        ID:        1,
        UserName:  "voiceuser",
        FirstName: "testing",
    ...
    correct := "voiceuser shared a voice message on Telegram with caption: 'Audio message'."
